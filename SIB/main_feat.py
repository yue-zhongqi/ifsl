...
from dataloader import TrainLoader, ValLoader, EpisodeSampler
...
class BaseTrainer:
    ...
    def test(self, epoch):
        ...
        for batchIdx in range(nEpisode):
            data = self.valLoader.getEpisode()
...
parser.add_argument('--dataset', type=str, default='tiered', choices=['miniImageNet', 'CUB', 'Cifar', 'tiered'], help='Which dataset? Should modify normalization parameter')
# Lr WarmUp
